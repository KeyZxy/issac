...
public class Clotty : MonoBehaviour
{
    ...
    public void RandomMove()
    {
        ...
        if (invoketime > attack_frequency)
        {
            ...
            bullet_up.GetComponent<Enemybullet>().SetSpeed(new Vector2(0, -EnemyBullet_Speed));
            bullet_down.GetComponent<Enemybullet>().SetSpeed(new Vector2(0, -EnemyBullet_Speed));
            bullet_left.GetComponent<Enemybullet>().SetSpeed(new Vector2(-EnemyBullet_Speed, 0));
            bullet_right.GetComponent<Enemybullet>().SetSpeed(new Vector2(EnemyBullet_Speed, 0));
            switch (direction)
            {
                case Direction.up:
